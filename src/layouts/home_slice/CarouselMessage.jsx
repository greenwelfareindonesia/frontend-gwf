...
const CarouselMessage = () => {
  ...
  return (
    <Container>
      <Slider slides={slides} parentClassName="!h-[100vh]" setCurrentIndex={setIndex} currentIndex={index}>
        <h1 className="text-center text-[#3E3E08] w-full font-bold italic text-lg">{slides[index].title}</h1>
        <p className="text-center text-[#3E3E08] w-full font-light italic text-sm leading-8">{slides[index].desc}</p>
      </Slider>
    </Container>
  );
};
