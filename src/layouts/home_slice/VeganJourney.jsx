...
const VeganJourney = () => {
  return (
    <Container className="my-0 md:my-16">
      <Image src={image_veganjourney} className="max-w-screen-xl h-full mx-auto">
        <div className="w-full h-full bg-[#3E3E08]/30 flex items-center flex-col justify-center py-10 md:py-60 gap-8 px-8 md:px-36">
          <motion.h1
          ...
          >
            With just one click, we have the perfect resource for you to start your vegan/vegetarian
            transition.
          </motion.h6>
          <motion.h6
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            A vegan diet has the lowest carbon footprint at just 1.5 tons CO2e (Carbon Dioxide
            Equivalent). You can reduce your foodprint by a quarter just by consuming a plant-based
            meal. It&sbquo;s good for the animals too!
          </motion.h6>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
