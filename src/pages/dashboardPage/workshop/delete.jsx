import { useDeleteWorkshop } from "../../../features/workshop/service";
import closeIcon from "../../../assets/icons/close_icon.svg";
import questionPerson from "../../../assets/icons/icon_questionperson.svg";

const Modal = ({ visible, notVisible, selectedWorkshop }) => {
  console.log("🚀 ~ Modal ~ selectedWorkshop:", selectedWorkshop);
  const { mutate } = useDeleteWorkshop();
