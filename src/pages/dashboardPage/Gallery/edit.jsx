  ...
  return (
    <DashboardSection titleField="Edit Post">
      ...
      <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
        ...
        <input
          {...register("alt", { required: true })} // Use register with required validation
        ...
        <div className="flex justify-center mt-28">
          <button type="button" onClick={handleBack} className="px-48 py-2 mr-4 font-semibold bg-white border rounded text-primary-2 border-primary-2">
            Batal
          </button>
