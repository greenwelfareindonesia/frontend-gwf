...
function VeganGuide() {
    ...
    >
      <div className="bg-white py-6 px-12 rounded-md flex flex-col text-primary-1 text-center underline font-light relative">
        <img
          src={Cross}
          alt="cross"
          className="w-[40px] absolute top-2 left-2 cursor-pointer"
          onClick={() => setIsOpen((prevState) => !prevState)}
        />
        <a
          href="https://www.instagram.com/burgreens/"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/honueats/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Honu Eats
        ...
        <a
          href="https://www.instagram.com/raysbottleofjoe/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Ray's Bottle of Joy
        ...
        <a
          href="https://www.instagram.com/therootsid/"
          target="_blank"
          rel="noopener noreferrer"
        >
          The Roots
        ...
        <a
          href="https://www.instagram.com/rumahjulietid/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Rumah Juliet
        ...
        <a
          href="https://www.instagram.com/green.grills/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Green Grills
        ...
        <a
          href="https://www.instagram.com/eath.plantbased/"
          target="_blank"
          rel="noopener noreferrer"
        >
          EATH Plant-based
        ...
        <a
          href="https://www.instagram.com/feelgoodfood.id/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Feel Good Food
        ...
        <a
          href="https://www.instagram.com/tiasa.plantbased/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Tiasa Plant-based
        ...
        <a
          href="https://www.instagram.com/thehenrebellion/"
          target="_blank"
          rel="noopener noreferrer"
        >
          The Hen Rebellion
        ...
        <a
          href="https://www.instagram.com/veganbaby.id/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Vegan Baby
        ...
        <a
          href="https://www.instagram.com/piringsayur/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Piring Sayur
        ...
        <a
          href="https://www.instagram.com/seedjkt/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Seed
        ...
        <a
          href="https://www.instagram.com/treatvegan_id/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Treat Vegan
        ...
        <a
          href="https://www.instagram.com/bakmivegan99/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Bakmi Vegan 99
        ...
        <a
          href="https://www.instagram.com/lokapadang_officialstore/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Loka Padang
        ...
        <a
          href="https://www.instagram.com/nutsybowl/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Nutsy Bowl
        ...
        <a
          href="https://www.instagram.com/iveganpizza/"
          target="_blank"
          rel="noopener noreferrer"
        >
          iVegan Pizza
        ...
        <a
          href="https://www.instagram.com/sematjam_id/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Sematjam
        ...
        <a
          href="https://www.instagram.com/sproutsparlor/"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://www.instagram.com/plantful.id/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Plantful
        ...
        <a
          href="https://www.instagram.com/fedwelljkt/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Fedwell Jakarta
        ...
        <a
          href="https://www.instagram.com/bluezone.id/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Bluezone
        ...
        <a
          href="https://www.instagram.com/vowgroup.id/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Vegan On Bowl
        ...
        <a
          href="https://www.instagram.com/thesupergrain/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Supergrain
        ...
        <a
          href="https://www.instagram.com/herbox.jkt/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Herbox Jakarta
  ...
  return (
    <div>
      ...
      {/* Header */}
      <section
        className="h-[31rem] bg-no-repeat bg-cover bg-center py-28 xl:px-[22rem]"
