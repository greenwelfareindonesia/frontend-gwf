      ...
      <section className="py-20 xl:px-60 px-4">
        ...
        <div className="xl:px-8 px-4 space-y-6 xl:space-y-10">
          <div className="xl:mb-16">
            ...
            >
              <li>
                ...
                gas emissions, more than the combined exhaust from all
                transportation.
              </li>
              <li>
              ...
              <li>
                Animal agriculture & livestock emits a lot of methane. Methane
                is 25-100 times more destructive than CO2 on a 20 year time
                frame. Methane also has a global warming potential 86 times that
                of CO2 on a 20 year time frame.
              </li>
              <li>
                Livestock is responsible for 65% of all human-related emissions
                of nitrous oxide - a greenhouse gas with 296 times the global
                warming potential of carbon dioxide, and which stays in the
          ...
          <div className="xl:mb-16">
            ...
            >
              <li>
                Animal agriculture water consumption ranges from 34-76 trillion
                gallons annually.
              </li>
              <li>
              ...
              <li>
                Animal Agriculture is responsible for 20% - 33% of all fresh
                water consumption in the world today.
              </li>
            </motion.ul>
          </div>
          <div className="xl:mb-16">
            ...
            >
              <li>
                Livestock or livestock feed occupies 1/3 of the earth's ice-free
                land.
              </li>
              ...
              <li>
                1/3 of the planet is desertified, with livestock as the leading
                driver.
              </li>
              <li>
                Land required to feed 1 person for 1 year; Vegan: 1/6th acre,
                Vegetarian: 3x as much as a vegan, Meat Eater: 18x as much as a
                vegan.
              </li>
              <li>
                1.5 acres can produce 37,000 pounds of plant-based food. 1.5
                acres can produce 375 pounds of beef.
              </li>
            </motion.ul>
          </div>
          <div className="xl:mb-16">
            ...
            >
              ...
              <li>
                A farm with 2,500 dairy cows produces the same amount of waste
                as a city of 411,000 people.
              </li>
              <li>
                In the U.S. alone, livestock produce 116,000 lbs of waste per
                second.
              </li>
              <li>
          ...
          <div className="xl:mb-16">
            ...
            >
              ...
              <li>
                The leading causes of rainforest destruction are livestock and
                feedcrops. Up to 137 plant, animal and insect species are lost
                every day due to rainforest destruction.
              </li>
              <li>
              ...
              <li>
                ...
                animals. Today, humans and the animals that we raise as food
                make up 98% of the zoomass.
              </li>
            </motion.ul>
          </div>
          <div className="xl:mb-16">
            ...
            >
              <li>
                70 billion farmed animals are reared annually worldwide. More
                than 6 million animals are killed for food every hour.
              </li>
              <li>
                Throughout the world, humans drink 5.2 billion gallons of water
                and eat 21 billion pounds of food each day. Whereas worldwide,
                cows drink 45 billion gallons of water and eat 135 billion
              ...
              <li>
                15x more protein on any given area of land with plants, rather
                than cows.
              </li>
              <li>Dairy consumption may lead to breast lumps.</li>
              <li>
                A person who follows a vegan diet produces the equivalent of 50%
                less carbon dioxide, uses 1/11th oil, 1/13th water, and 1/18th
                land compared to a meat-lover for their food.
              </li>
              <li>
                Each day, a person who eats a vegan diet saves 1,100 gallons of
                water, 45 pounds of grain, 30 sq ft of forested land, 20 lbs CO2
