...
export default function Team() {
  ...
  return (
    <>
      ...
      {isMobile ? (
        <div>
          <section className="bg-primary-1 text-light-1 py-8">
            <h1 className="font-bold text-center text-2xl mb-4 ">Founding Members</h1>
            <Slider {...getSliderSettings()}>
              {cards.map((member, index) => (
                <div key={index} className="">
                  <div className="w-40 h-40 mx-auto">
                    <img className="w-full h-full rounded-b-2xl rounded-tr-2xl object-cover" src={member.img} alt={member.nama} />
                    <p className="text-center pt-3 font-semibold">{member.nama}</p>
                    <p className="text-center">{member.peran}</p>
                  </div>
                </div>
              ))}
            </Slider>
          ...
          <section className="py-8 text-primary-1">
            <h1 className="font-bold text-center text-2xl mb-4">Current Executive Leads</h1>
            <Slider {...getSliderSettings()}>
              {cards.map((member, index) => (
                <div key={index} className="mx-2">
                  <div className="w-40 h-40 mx-auto">
                    <img className="w-full h-full rounded-full object-cover" src={member.img} alt={member.nama} />
                    <p className="text-center pt-3 font-semibold">{member.nama}</p>
                    <p className="text-center">{member.peran}</p>
                  </div>
                </div>
          ...
          <section className="py-8 bg-primary-1 text-light-1">
            <h1 className="font-bold text-center text-2xl mb-4">Board of Director</h1>
            <Slider {...getSliderSettings()}>
              {cards.map((member, index) => (
                <div key={index} className=" mx-2">
                  <div className="w-40 h-40 mx-auto">
