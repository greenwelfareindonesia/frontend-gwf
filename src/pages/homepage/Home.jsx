    ...
    <div>
      ...
      >
        <div className="flex flex-col justify-center h-full">
          ...
          <h2 className="text-center text-white font-inter text-4xl">
            My Climate Wishes
          </h2>
        </div>
      </section>
        ...
        <div className="lg:flex lg:justify-center mb-28">
          ...
          <div className="ml-2 lg:ml-8 lg:h-[18rem]">
            ...
            <p className="w-[26.5rem] text-xs text-white lg:text-sm leading-7">
              ...
              need. Donations will also be allocated to GWF&apos;s hydroponics
              program to install sustainable hydroponics units in
      ...
      <section className="pt-12 lg:pt-24 lg:pb-20">
        <div>
          <h4 className="text-[#5F5E36] text-center font-inter text-2xl mb-8">
            Get our Merch
          </h4>
          <p className="text-[#3E3E08] text-center font-inter text-base mb-20">
            Spend it for what it&apos;s worth - 100% of the revenue will be
            directed to <br /> support our non-profit programs and operational
            costs!
          </p>
        </div>
        <div className="flex flex-col lg:justify-center lg:flex-row relative">
          <div>
            <img
              src={tumblrImage}
              alt="Tumblr Image"
              className="lg:w-[42rem] lg:h-[40rem] lg:mr-3"
            />
            <button
