    ...
    <section className="bg-[#3E3E08] flex h-screen">
      ...
      <div className="w-1/2 h-screen px-28 py-28 ">
        <div className="bg-white w-full h-full mx-auto rounded-[3rem] flex flex-col items-center justify-center relative">
          ...
          <h2 className="text-[#3E3E08] font-semibold text-xl text-center ">Welcome GWF Team!</h2>
          <form action="post" className="flex flex-col mt-8 mb-6">
            ...
            <div className="flex items-center mb-8">
              <input type="checkbox" id="remember" {...register("remember")} className="mr-1" />
              <label htmlFor="remember" className="text-xs">
                Remember Me
              </label>
              <p className="text-xs ml-auto font-extralight hover:cursor-pointer hover:underline">Forgot Your Password?</p>
            </div>
            <button
          ...
          <p className="font-medium text-xs absolute bottom-2">©2023 by Green Welfare Indonesia</p>
        </div>
      </div>
      {/* Right Side */}
      <div className="w-1/2 bg-cover flex justify-center items-center" style={{ backgroundImage: `url(${adminBg})` }}>
        <div className="bg-[#3E3E08] bg-opacity-50 w-fit px-16 pt-6 pb-28 rounded-3xl">
          ...
          <p className="text-white text-center font-light text-lg w-[31rem]">
            Fostering eco-social change by empowering young changemakers through climate education and food security
          </p>
        </div>
      </div>
    </section>
